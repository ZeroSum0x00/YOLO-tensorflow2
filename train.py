...
def train(file_config):
    ...
    if train_prepare(train_config['mode']):
        ...
        train_generator, val_generator = get_train_test_data(data_dirs               = data_config['data_dir'], 
        ...
        for callback in callbacks:
            if isinstance(callback, mAPEvaluate):
                callback.pass_data(val_generator)
        ...
        model.fit(train_generator,
                  ...
                  validation_steps    = val_generator.n // train_config['batch_size'],
